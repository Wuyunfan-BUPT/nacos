...
public class NamingGrpcClientProxy extends AbstractNamingClientProxy {
    ...
    public NamingGrpcClientProxy(String namespaceId, NacosClientAuthServiceImpl nacosClientAuthService, ServerListFactory serverListFactory,
            Properties properties, ServiceInfoHolder serviceInfoHolder) throws NacosException {
        super(nacosClientAuthService, properties);
