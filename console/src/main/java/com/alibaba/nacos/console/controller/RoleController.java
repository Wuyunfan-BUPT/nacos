...
public class RoleController {
     ...
     */
    @GetMapping
    @Secured(resource = AuthNacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "roles", action = ActionTypes.READ)
     ...
     */
    @PostMapping
    @Secured(resource = AuthNacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "roles", action = ActionTypes.WRITE)
