...
public class PermissionController {
     ...
     */
    @GetMapping
    @Secured(resource = AuthNacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "permissions", action = ActionTypes.READ)
     ...
     */
    @PostMapping
    @Secured(resource = AuthNacosAuthConfig.CONSOLE_RESOURCE_NAME_PREFIX + "permissions", action = ActionTypes.WRITE)
